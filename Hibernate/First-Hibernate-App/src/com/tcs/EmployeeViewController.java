	...
	public static void main(String[] args) {
		...
		do {
			...
			case 4: 
				...
				Employee employe = dao.fetchEmployee(scan.nextInt());
				if(employe != null) {
					System.out.println("Enter salary to be updated");
					employe.setSalary(scan.nextDouble());
					dao.updateSalary(employe);
				} else {
					System.err.println("Sorry employee not found");
				}
				break;
			case 5: 
				...
				Employee employ = dao.fetchEmployee(scan.nextInt());
				if(employ != null) {
					dao.deleteById(employ);
				} else {
					System.err.println("Sorry employee not found");
				}
				break;
